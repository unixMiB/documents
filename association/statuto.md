...
### 1.1 Denominazione
È costituita l’associazione unixMiB (d’ora in poi indicata semplicemente con il termine Associazione). L’Associazione non ha finalità di lucro e gli eventuali utili conseguiti dovranno essere utilizzati per il conseguimento degli scopi istituzionali dell’associazione stessa. L’Associazione è svincolata da qualsiasi ideologia politica o religiosa.
### 1.2 Oggetto
...
Sono definiti "software liberi" nel senso inteso dall'associazione tutte le opere che sono state contrassegnate dai loro autori con una licenza che ne permetta l'elaborazione e/o la diffusione gratuita.
